...
drop function if exists public.touch_user_activity() cascade;
drop table if exists public.integration_checks;
drop table if exists public.support_github_message_exports;
drop table if exists public.user_activity_summary;
drop table if exists public.support_internal_notes;
...
drop table if exists public.trade_sync_runs;
