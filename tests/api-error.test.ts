...
test('server log values redact bearer tokens, keys, emails, and UUIDs',()=>{
 const value=sanitizeLogValue('Bearer abc.def.ghi api_key=topsecret user@example.com 123e4567-e89b-12d3-a456-426614174000');
 assert.doesNotMatch(value,/abc\.def\.ghi|topsecret|user@example\.com|123e4567-e89b-12d3-a456-426614174000/);
});
